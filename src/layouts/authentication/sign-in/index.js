...
//   const [name, setName] = useState("");
//   const [mobile, setMobile] = useState("");
//   const [snackbar, setSnackbar] = useState({ open: false, message: "", color: "" }); // Snackbar state
//   const navigate = useNavigate();

//   const handleSubmit = async (event) => {
//     event.preventDefault();
//     if (name.startsWith(" ") || name.trim() === "") {
//       setSnackbar({ open: true, message: "Name cannot start with a space or be empty.", color: "error" });
//       return;
//     }
//     if (!/^\d+$/.test(mobile)) {
...
//           setTimeout(() => {
//             navigate("/dashboard");
//           }, 1500); // Delay navigation to show the snackbar
//         } else {
